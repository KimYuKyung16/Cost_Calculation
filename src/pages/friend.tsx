...
const Main__AddFriend = styled.div`
  ...
  @media screen and (max-width: 768px) {
    ...
    height: 90%;
    position: absolute;
    transform: ${(props: AddFriend_Props) =>
      props.visible === "block" ? "translateY(-0%)" : "translateY(100%)"};
    transition: ${(props: AddFriend_Props) =>
      props.visible === "block"
...
const Black = styled.div`
  ...
  @media screen and (max-width: 768px) {
    ...
    opacity: ${(props: AddFriend_Props) =>
      props.visible === "block" ? "80%" : "0%"};
    z-index: 1;
  }
`;
